                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary"><spring:message code="experiment.delete.message"/></h6>
                            </div>
                            <div class="card-body">
                                <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="/user/account/${userId}"><spring:message code="user.back"/></a> <br><br>
                                <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="/experiment/delete/${id}"><spring:message code="experiment.delete"/></a>
                            </div>
                        </div>
